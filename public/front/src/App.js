...
class SortingForm extends React.Component {
    constructor(props) {
        ...
        this.handleWriteDB = this.handleWriteDB.bind(this);
        ...
        <>
            <form>
                <div className="container-fluid">
                  ...
                  <button className="btn btn-primary"   onClick={this.handleDisplay}    formMethod="get"  type="submit" name="action"   value="sort">Sort</button>
                  ...
                  <button className="btn btn-secondary" onClick={this.handleWriteDB}    formMethod="post" type="submit" name="action"   value="db">DB record</button>
                </div>
                <hr/>
                <p>{this.state.name}</p>
